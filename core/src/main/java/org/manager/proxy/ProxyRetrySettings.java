...
public class ProxyRetrySettings {
    ...
    /**
     * @return always the configured value, but note the value has no effect
     * @deprecated No effect: the retry budget is global and monotonic.
     *             Resetting the counter on proxy change made retries
     *             unbounded when rotation was active (the proxy changes every
     *             attempt). Kept for API compatibility.
     */
    @Deprecated
    ...
    /**
     * @deprecated No effect: the retry budget is global and monotonic. See
     *             {@link #isResetRetriesOnProxyChange()}.
     */
    @Deprecated
